...
type Config struct {
	...
	// Distinguish* gate when within-ambiguity-margin pairs may resolve vs conflict (ADR-001 amendment).
	DistinguishAmountEpsilon   float64                         `json:"DistinguishAmountEpsilon"`
	DistinguishMerchantEpsilon float64                         `json:"DistinguishMerchantEpsilon"`
	DistinguishTemporalSecs    float64                         `json:"DistinguishTemporalSecs"`
...
func DefaultConfig() Config {
	return Config{
		...
		DistinguishAmountEpsilon:   0.01,
		DistinguishMerchantEpsilon: 0.01,
		DistinguishTemporalSecs:    120,
		WeightAmount:               0.42,
		WeightTemporal:             0.23,
		WeightMerchant:             0.30,
		WeightMCC:                  0.05,
